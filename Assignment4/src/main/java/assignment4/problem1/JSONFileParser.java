...
/**
 * JSONFileParser is class which parses grammar json file and return grammar instance of Grammar class
 *
...
public class JSONFileParser {
  ...
  /**
   * Constructor of JSONFileParser which validates JSON File, if not valid then throws InvalidJSONFileException exception
   *
   ...
   *
   * @return Represented as Grammar, provides information like grammar title, grammar desc, and other elements in map
   */
