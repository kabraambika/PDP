...
/**
 * MissingDefinitionException is a custom exception class which extends RuntimeException. This
 * exception is thrown when there is no value provided in grammar for element to create a sentence.
 *
