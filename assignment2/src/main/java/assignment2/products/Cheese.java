...
/**
 * Cheese is a type of AbstractGrocery product It contains information like manufacturer,
...
public class Cheese extends AbstractGrocery {
  ...
  /**
   * Constant for product type cheese
   */
   ...
   */
  public Cheese(Manufacturer manufacturer, String productName, Double price,
