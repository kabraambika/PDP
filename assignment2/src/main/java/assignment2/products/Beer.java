...
/**
 * Beer is a type of AbstractGrocery product It contains information like manufacturer, productName,
 * price, minimum age, product weight.
 *
...
public class Beer extends AbstractGrocery {
  ...
  /**
   * Constant for product type beer
   */
