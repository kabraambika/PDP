...
/**
 * HeadOfHousehold is a class for Head of household group filer type
...
public class HeadOfHousehold extends GroupFiler {
  ...
  /**
   * Constructor of HeadOfHousehold class
   ...
   */
  public HeadOfHousehold(String taxID, ContactInfo contactInfo, Double lastYrEarning,
  ...
  /**
   * Calculate tax amount for Head of household group type
